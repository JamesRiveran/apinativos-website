...
const Footer: React.FC = () => {
  ...
  const currentData = businessId ? getBusinessById(businessId) : undefined;
  const contactInfo = currentData?.contactInfo || associationData.contactInfo;
  const socialMedia = currentData?.socialMedia || associationData.socialMedia;
  const name = currentData?.name || associationData.name;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to={urlPrefix || "/"} className="hover:text-accent">
                  Inicio
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              {socialMedia.whatsapp && (
                <a
                  href={`https://wa.me/${socialMedia.whatsapp.replace(
                    /[^0-9]/g,
                    ""
                  )}`}
                  target="_blank"
